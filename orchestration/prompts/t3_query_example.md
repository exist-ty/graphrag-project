...
- Write the complete file directly to `scripts/query_example.py`. Do not return code in the reply: it is put through a mechanical gate, not read, so code in the response is wasted output.
